...
def load_settings():
    try:
        with open("address.json", "r") as file:
            ...
            load_label = tk.Label(load_window, text="Select an address to load:")
            load_label.pack()
            ...
            load_button = tk.Button(load_window, text="Load", command=select_address)
            ...
            remove_button = tk.Button(load_window, text="Remove", command=remove_address)
